...
<button id="back"><a href="adminvehicle.php">HOME</a></button> 
 ...
 <div class="main">
        ...
        <form id="register"  action="upload.php" method="POST" enctype="multipart/form-data">    
            ...
            id="name" placeholder="matricule number" required>
            <br><br>

            <label>Model : </label>
            <br>
            <input type ="text" name="model"
            id="name" placeholder="Enter the car model" required>
            <br><br>
            ...
            id="name" placeholder="Enter Price Of Car for One Day(in FCFA)" required>
            <br><br>

            <label>Car_type : </label>
            <br>
            <input type ="text" name="cartype"
            id="name" placeholder="Automatic OR Manual" required>
            <br><br>
